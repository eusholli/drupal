...
function earthen_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function earthen_menu_local_task($link, $active = FALSE) {
...
function earthen_breadcrumb($breadcrumb) {
...
function earthen_comment_wrapper($content, $type = null) {
  static $node_type;
 ...
 * @ingroup themeable
 */
function earthen_button($element) {
...
*/
function earthen_img_assist_page($content, $attributes = NULL) {
