<?php
// $Id: search-theme-form.tpl.php,v 1.1 2009/08/19 04:28:07 sociotech Exp $
...
<div id="search" class="container-inline">
  <input class="search-input form-text" type="text" maxlength="128" name="search_theme_form" id="edit-search_theme_form"  size="15" value="" title="<?php print t('Enter search terms') ?>" />
